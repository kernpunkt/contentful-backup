...
export class ContentfulBackupStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const { PREFIX, SCHEDULE, CONTENTFUL_MANAGEMENT_TOKEN, CONTENTFUL_SPACE_ID, CONTENTFUL_ENVIRONMENT_ID, TIMEOUT_MINUTES, MEMORY_SIZE } = process.env;
    ...
    const contentfulBackupFunction = new NodejsFunction(this, `${PREFIX}-contentful-backup`, {
