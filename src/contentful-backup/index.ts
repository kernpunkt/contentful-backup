...
export const handler = async (
    ...
    const executable = path.join(process.env.LAMBDA_TASK_ROOT as string, '/node_modules/contentful-cli/bin/contentful.js');
    const exportDir = "/tmp";
    ...
    const promise = new Promise((resolve, reject) => {
        ...
        child.on("close", async (code) => {
          ...
          console.log(`reading files from ${exportDir}, found ${files.length} files.`);
